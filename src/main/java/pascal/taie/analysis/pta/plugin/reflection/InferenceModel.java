...
import pascal.taie.analysis.pta.core.solver.VisitorState;
        ...
        if (clazz != null) {
            ...
            if (result != null) {
                ...
                constructors.map(helper::getMetaObj)
                        .forEach(ctorObj -> solver.propagateNew(context, result, ctorObj));
            }
        }
    }
        ...
        if (clazz != null && name != null) {
            ...
            if (result != null) {
                ...
                methods.map(helper::getMetaObj)
                        .forEach(mtdObj -> solver.propagateNew(context, result, mtdObj));
            }
        }
    }
}
