...
public interface Plugin {
     ...
     */
    default void onNewStmt(Stmt stmt, JMethod container,Context context) {
    }
    ...
    default void reflectionHandler(CSMethod csMethod,Invoke invoke) {
    }
    ...
    default boolean judgeCheck(Edge<CSCallSite, CSMethod> edge, CSVar csVar, AtomicBoolean flag) {
        return false;
    }

    default boolean judgeCallSource(Edge<CSCallSite, CSMethod> edge, AtomicBoolean flag) {
        return false;
    }

    default void TransferCallSource(Edge<CSCallSite, CSMethod> edge) {
    }
