...
//                    solver.addVarPointsTo(context, result,
                    solver.propagateNew(context, result,
...
//                                solver.addVarPointsTo(context, result, annoObj);
                                solver.propagateNew(context, result, annoObj);
                            }
                        }
                    });
                }
            ...
            mtdObjs.forEach(mtdObj -> {
                ...
                if (method != null) {
                    ...
                    if (!paramAnnos.isEmpty()) {
                        ...
                        solver.propagateNew(csManager.getArrayIndex(csAnno1Array), annoSet);
                        ...
                        solver.propagateNew(csManager.getArrayIndex(csAnno2Array), csAnno1Array);
                        // result = anno2Array;
                        solver.propagateNew(context, result, anno2Array);
                    }
                }
            });
        }
