...
//                            solver.addVarPointsTo(context, currentThreadReturn, pts));
                            solver.propagateNew(solver.getCSManager().getCSVar(context, currentThreadReturn),pts));
                }
            }
        }
    }
...
//                solver.addVarPointsTo(context, currentThreadReturn, runningThreads);
                solver.propagateNew(solver.getCSManager().getCSVar(context, currentThreadReturn),runningThreads);
            }
        }
    }
}
