...
public class SootWorldBuilder extends AbstractWorldBuilder {
    ...
    public void build(Options options, List<AnalysisConfig> analyses) {
        ...
        try {
            ...
            // 特别处理 NullPointerException
            System.err.println("Caught NullPointerException: " + e.getMessage());
            e.printStackTrace();
        } catch (Exception e) {
            // 捕获并忽略所有异常，同时记录详细的警告信息
    ...
    private static void initSoot(Options options, List<AnalysisConfig> analyses,
        ...
        // 确保所有类都设置为 HIERARCHY 级别
//        setAllClassesToHierarchy(scene);
    ...
    private static void setAllClassesToHierarchy(Scene scene) {
    ...
    private static void addBasicClasses(Scene scene) {
        ...
        try {
            ...
            classNames.forEach(name -> {
                    scene.addBasicClass(name, HIERARCHY);
            });
        } catch (IOException e) {
